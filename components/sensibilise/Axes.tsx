      ...
      <div className="container mx-auto px-4 md:px-16 lg:px-20">
        ...
        <div ref={cardsRef} className="grid md:grid-cols-3 gap-8">
          {axes.map((item, i) => (
            <div 
              key={i} 
              className="axis-card group relative p-8 bg-white *border border-slate-200 rounded-3xl *shadow-sm hover:shadow-sm hover:-translate-y-2 transition-all duration-300"
            >
