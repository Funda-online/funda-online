...
import { Check, CheckCircle2, ClipboardCheck, Users } from "lucide-react";
      ...
      <div className="container mx-auto px-4 md:px-16 lg:px-20">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground">
            Modèle <span className="text-primary">d'intervention</span>
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
            Une collaboration claire pour garantir le succès et l'impact de
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {/* Funda Side */}
          <div className="bg-primary p-8 md:p-11 rounded-4xl text-white *shadow-xl shadow-primary/20">
            ...
            <ul className="space-y-4">
              {responsibilities.funda.map((item, i) => (
                <li key={i} className="flex items-start gap-3 text-white/90">
                  ...
                  <span className="mt-1 shrink-0 flex items-center justify-center w-5 h-5 rounded-full bg-white">
          ...
          {/* Beneficiary Side */}
          <div className="bg-white p-8 md:p-11 rounded-4xl *border border-slate-200 *shadow-sm">
            <div className="flex items-center gap-4 mb-8">
              ...
              {responsibilities.beneficiaire.map((item, i) => (
                ...
                >
                  {/* <CheckCircle2
                    ...
                    size={20}
                  /> */}
                  <span className="mt-1 shrink-0 flex items-center justify-center w-5 h-5 rounded-full bg-primary">
